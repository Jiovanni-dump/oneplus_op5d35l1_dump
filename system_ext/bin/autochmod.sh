...
function handle_m_commonLog(){
    ...
    echo "Regular logs(such as android.log event.log kernel.log) are kept in" \
        "/common/ap_log or minilog !!!" > ${DATA_LOG_DEBUG_PATH}/00_Android_and_kernel_log_has_been_move_to_aplog_or_minilog
